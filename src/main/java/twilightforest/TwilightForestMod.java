...
public class TwilightForestMod implements ModInitializer {
	...
	public static final GameRules.Key<GameRules.BooleanValue> ENFORCED_PROGRESSION_RULE = GameRuleRegistry.register("tfEnforcedProgression", GameRules.Category.UPDATES, GameRuleFactory.createBooleanRule(true, (server, enforced) -> TFPacketHandler.CHANNEL.sendToServer(new UpdateGamerulePacket(enforced.get())))); //Putting it in UPDATES since other world stuff is here
