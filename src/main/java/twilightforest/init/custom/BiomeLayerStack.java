...
public class BiomeLayerStack {
	...
	/**
	 * don't use this, use getAllBiomesHolder()
	 */
	@Deprecated
	private static Holder<BiomeLayerFactory> allBiomesHolder;
	public static Holder<BiomeLayerFactory> getAllBiomesHolder() {
	...
	public static void bootstrap(BootstapContext<BiomeLayerFactory> context) {
		FilteredBiomeLayer.Factory biomeLayerFactory = (FilteredBiomeLayer.Factory) getAllBiomesHolder().value();
		context.register(RANDOM_FOREST_BIOMES, biomeLayerFactory.fallbackLayer().value());
		context.register(BIOMES_ALONG_STREAMS, biomeLayerFactory);
	}
